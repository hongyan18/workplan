<template>
    <div class="calendar-container">
        ...
        <ul class="date">
            ...
            <li class="datelicli" @click="clickEvent" v-for="day in nowMonthDays" :key="day" >{{day}}</li>
...
export default {
  ...
  methods: {
    ...
    clickEvent (e) {
      ...
      let timevalue = date.year + '-' + date.month + '-' + date.day
      this.testtime = timevalue
      // 将最后鼠标点击的时间传回父组件
      this.$emit('returnparent', timevalue)
